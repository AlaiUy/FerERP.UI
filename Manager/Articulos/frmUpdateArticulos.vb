...
Public Class frmUpdateArticulos
    ...
    Private Sub Popular()
        ...
        If Not IsNothing(_articulo) Then
            ...
            chkDescatalogado.Checked = _articulo.Activo
            txtStockActual.Text = _articulo.Stock
            Try
    ...
    Private Sub frmUpdateArticulos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            MsgBox("El articulo fue actualizado con exito", vbOKOnly, "Exito.")
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Private Sub btnAsignarStock_Click(sender As Object, e As EventArgs) Handles btnAsignarStock.Click
        Try
            Dim Cantidad As Decimal = Convert.ToDecimal(txtStocktoAssing.Text)
            If Cantidad <= 0 Then
                MsgBox("La cantidad a asignar no puede ser 0", vbOKOnly)
                Return
            End If
            If MsgBox("Desea asignar esa cantidad como estock total de la empresa para este articulo?", vbOKCancel, "Atencion") = MsgBoxResult.Ok Then
                GesArticulos.getInstance().UpdateStock(_articulo, Cantidad)
                MsgBox("Stock actualizado con exito", vbOKOnly, "Exito")
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Private Sub txtStocktoAssing_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtStocktoAssing.KeyPress
